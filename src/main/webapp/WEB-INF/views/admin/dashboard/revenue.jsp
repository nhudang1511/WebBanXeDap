			...
			<div class="x_panel">
				...
				<div class="x_content">
					<ul class="stats-overview">
                        <li>
                          <span class="name"> Tổng thu trong tháng </span>
                          <span class="value text-success"> ${totalOfMonth } </span>
                        </li>
                        <li>
                          <span class="name"> Tổng thu trong năm </span>
                          <span class="value text-success"> ${totalOfYear } </span>
                        </li>
                        <li class="hidden-phone">
                          <span class="name"> Tổng thu trong 5 năm </span>
