...
<body>
	<c:url value="/admin/delivery" var="deletelist"></c:url>
			...
			<div class="x_panel">
				<div class="x_title">
					...
					<ul class="nav navbar-right panel_toolbox">
						<li><a href="<c:url value='/admin/delivery/add'/>"
						...
						<div class="col-sm-12">
							<div class="card-box table-responsive">
								...
								<table id="datatable-checkbox"
									...
									<tbody>
										<c:forEach items="${deliveryList}" var="model">
											<tr class="odd pointer">
												...
												<td class=" last"><a
													href="<c:url value='/admin/delivery/detail?_id=${model._id}'/>">View</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
